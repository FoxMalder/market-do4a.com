(function (factory) {
	...
	/*#__PURE__*/
	function () {
	  function MreSlider(element, options) {
	    var _this = this;

	    _defineProperty(this, "onScroll", function (e) {
	    ...
	    _defineProperty(this, "onMouseEnter", function () {// this.showScrollbar('x');
	      // this.showScrollbar('y');
	    });

	    _defineProperty(this, "onMouseMove", function (e) {
	      _this.mouseX = e.clientX; // if ( this.axis.x.isOverflowing || this.axis.x.forceVisible ) {
	      // console.log(this.mouseX);

	      _this.onMouseMoveForAxis(); // }
	    ...
	    _defineProperty(this, "onMouseLeave", function () {
	      ...
	      _this.onMouseLeaveForAxis();

	      _this.mouseX = -1;
	    });

	    _defineProperty(this, "onWindowResize", function () {// Recalculate scrollbarWidth in case it's a zoom
	    ...
	    _defineProperty(this, "onPointerEvent", function (e) {
	      var isWithinBoundsX;
	      _this.scrollbar.rect = _this.scrollbar.el.getBoundingClientRect();
	      isWithinBoundsX = _this.isWithinBounds(_this.scrollbar.rect); // If any pointer event is called on the scrollbar
	      ...
	      if (isWithinBoundsX) {
	        ...
	        e.stopPropagation(); // console.log('onPointerEvent');
	    ...
	    _defineProperty(this, "drag", function (e) {
	      ...
	      var contentSize = _this.contentEl[_this.axis[_this.draggedAxis].scrollSizeAttr];
	      var trackSize = track.rect[_this.axis[_this.draggedAxis].sizeAttr];
	      var hostSize = parseInt(_this.elStyles[_this.axis[_this.draggedAxis].sizeAttr], 10);
	      var scrollbar = _this.scrollbar; // console.log(contentSize, trackSize, hostSize);

	      e.preventDefault();
	      e.stopPropagation();
	      eventOffset = e.pageX;
	      var dragPos = eventOffset - track.rect[_this.axis[_this.draggedAxis].offsetAttr] - _this.axis[_this.draggedAxis].dragOffset;
	      var handleOffset = dragPos / (trackSize - scrollbar.size) * (contentSize - hostSize);
	      ...
	      _this.axis[_this.draggedAxis].scrollOffset = handleOffset;
	      _this.contentEl.style.transform = "translate3d(" + -handleOffset + "px, 0, 0)";
	    ...
	    this.options = _objectSpread({}, MreSlider.defaultOptions, options);
	    this.classNames = _objectSpread({}, MreSlider.defaultOptions.classNames, this.options.classNames);
	    this.axis = {
	      x: {
	        scrollOffset: 0,
	        sizeAttr: 'width',
	  ...
	  MreSlider.removeObserver = function removeObserver() {
	    this.globalObserver.disconnect();
	  };

	  MreSlider.getOffset = function getOffset(el) {
	  ...
	  var _proto = MreSlider.prototype;
	  ...
	  _proto.initDOM = function initDOM() {
	    ...
	    if (Array.from(this.el.children).filter(function (child) {
	      ...
	      this.contentEl = this.el.querySelector("." + this.classNames.content); // this.trackEl = this.el.querySelector(`.${this.classNames.track}`);
	    ...
	    this.scrollbar.el = this.track.el.querySelector("." + this.classNames.scrollbar); // this.axis.y.scrollbar.el = this.axis.y.track.el.querySelector(
	  ...
	  _proto.initListeners = function initListeners() {
	    ...
	    this.el.addEventListener('mouseleave', this.onMouseLeave); // this.contentEl.addEventListener('scroll', this.onScroll);
	  ...
	  _proto.positionScrollbar = function positionScrollbar(axis) {
	    ...
	    var trackSize = this.track.rect[this.axis[axis].sizeAttr];
	    var hostSize = parseInt(this.elStyles[this.axis[axis].sizeAttr], 10);
	    var scrollbar = this.scrollbar;
	    var scrollOffset = this.axis[axis].scrollOffset;
	    var scrollPourcent = scrollOffset / (contentSize - hostSize);
	    var handleOffset = ~~((trackSize - scrollbar.size) * scrollPourcent); // console.log(handleOffset);
	  ...
	  _proto.onMouseMoveForAxis = function onMouseMoveForAxis() {
	    this.track.rect = this.track.el.getBoundingClientRect();
	    this.scrollbar.rect = this.scrollbar.el.getBoundingClientRect();
	    var isWithinScrollbarBoundsX = this.isWithinBounds(this.scrollbar.rect);
	  ...
	  _proto.onMouseLeaveForAxis = function onMouseLeaveForAxis() {
	    this.track.el.classList.remove(this.classNames.trackHover);
	    this.scrollbar.el.classList.remove(this.classNames.scrollbarHover);
	  };
	  ...
	  _proto.onDragStart = function onDragStart(e, axis) {
	    ...
	    var scrollbar = this.scrollbar.el; // Measure how far the user's mouse is from the top of the scrollbar drag handle.

	    var eventOffset = e.pageX; // console.log(eventOffset);

	    this.axis[axis].dragOffset = eventOffset - scrollbar.getBoundingClientRect()[this.axis[axis].offsetAttr];
	    this.draggedAxis = axis; // console.log(this.axis[axis].dragOffset);
	  ...
	  _proto.removeListeners = function removeListeners() {
	    ...
	    this.el.removeEventListener('mouseleave', this.onMouseLeave); // this.contentEl.removeEventListener('scroll', this.onScroll);
	    ...
	    this.onMouseMove.cancel(); // this.hideScrollbars.cancel();
	  ...
	  _proto.destroy = function destroy() {
	    ...
	    while (this.contentEl.firstChild) {
	      this.el.appendChild(this.contentEl.firstChild);
	    }
	  ...
	  _proto.isWithinBounds = function isWithinBounds(bbox) {
	    return this.mouseX >= bbox.left && this.mouseX <= bbox.left + bbox.width // this.mouseY >= bbox.top &&
	...
	_defineProperty(MreSlider, "defaultOptions", {
	  classNames: {
	...
	function mainSlider() {
	  var $controlItem = $('.hero-slider-control__item');
	...
	function initHeader() {
	  ...
	  var menuButtonEl = headerEl.querySelector('.header-control__menu-btn');
	...
	function initMain() {
	  ...
	  mainSlider(); // $('.hero-slider__sliders').addClass('owl-carousel');
