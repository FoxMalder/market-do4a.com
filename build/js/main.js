(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('modules/MreSlider')) :
	typeof define === 'function' && define.amd ? define(['modules/MreSlider'], factory) :
	(global = global || self, factory(global.MreSlider));
}(this, function (MreSlider) { 'use strict';

	MreSlider = MreSlider && MreSlider.hasOwnProperty('default') ? MreSlider['default'] : MreSlider;
	...
	function initHeader() {
	  var headerEl = document.querySelector('.header'); // const fixedHeaderEl = headerEl.querySelector('.header__fixed-block');
	  ...
	  var fixedHeaderEl = document.getElementById('fixed-header-on-desktop');
	  var isFixed = false;
	  var headerOffset = 0;
	  ...
	  function initMobile() {
	    wrapperEl.style.paddingTop = "".concat(controlPanelEl.getBoundingClientRect().height, "px");
	    mobileMenuEl.style.top = "".concat(controlPanelEl.getBoundingClientRect().height, "px");
