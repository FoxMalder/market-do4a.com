(function () {
	...
	function initMain() {
	  ...
	  function initDesktop() {
	    ...
	    $brandsList.removeClass('owl-carousel'); // starSlider = new MreSlider($starSlider);
	  ...
	  var starsSlider = new Swiper('#stars-slider', {
	    slidesPerView: 'auto',
	    freeMode: true,
	  ...
	  var bestArticlesSlider = new Swiper('.best-articles__slider', {
	    slidesPerView: 'auto',
	    spaceBetween: 24,
	    touchEventsTarget: 'wrapper',
	    containerModifierClass: 'slider_',
	    ...
	    scrollbar: {
	      ...
	      draggable: true,
	      dragSize: 80,
	      dragClass: 'slider__track' // snapOnRelease: false,
