(function () {
	...
	function () {
	  function MreSlider(element, options) {
	    ...
	    _classCallCheck(this, MreSlider);
	    ...
	    _defineProperty(this, "onPointerEvent", function (e) {
	      var isWithinBoundsX = _this.isWithinBounds(_this.scrollbar.rect);

	      _this.scrollbar.rect = _this.scrollbar.el.getBoundingClientRect(); // If any pointer event is called on the scrollbar
	    ...
	    _defineProperty(this, "drag", function (e) {
	      ...
	      _this.contentEl.style.transform = "translate3d(".concat(-handleOffset, "px, 0, 0)");
	  ...
	  _createClass(MreSlider, [{
	    ...
	    value: function initDOM() {
	      ...
	      if (Array.from(this.el.children).filter(function (child) {
	        ...
	        this.contentEl = this.el.querySelector(".".concat(this.classNames.content)); // this.trackEl = this.el.querySelector(`.${this.classNames.track}`);

	        this.track.el = this.el.querySelector(".".concat(this.classNames.track));
	      } else {
	        // Prepare DOM
	      ...
	      this.scrollbar.el = this.track.el.querySelector(".".concat(this.classNames.scrollbar)); // this.axis.y.scrollbar.el = this.axis.y.track.el.querySelector(
	    ...
	    value: function recalculate() {
	      ...
	      this.contentEl.style.padding = "".concat(this.elStyles.paddingTop, " ").concat(this.elStyles.paddingRight, " \n      ").concat(this.elStyles.paddingBottom, " ").concat(this.elStyles.paddingLeft);
	      this.wrapperEl.style.margin = "-".concat(this.elStyles.paddingTop, " -").concat(this.elStyles.paddingRight, " \n      -").concat(this.elStyles.paddingBottom, " -").concat(this.elStyles.paddingLeft);
	      this.track.rect = this.track.el.getBoundingClientRect();
	      this.scrollbar.size = 80;
	      this.scrollbar.el.style.width = "".concat(this.scrollbar.size, "px");
	      this.contentEl.style.width = "".concat(this.contentEl.scrollWidth, "px");
	    ...
	    value: function positionScrollbar() {
	      ...
	      scrollbar.el.style.transform = "translate3d(".concat(handleOffset, "px, 0, 0)");
	...
	function mainSlider() {
	  ...
	  function slideTo(count) {
	    ...
	    $(".hero-slider-control__item[data-slide=".concat(count, "]")).addClass('active');
	    $('.hero-slider__slide').removeClass('active');
	    $('.hero-slider__slide').removeClass('animate');
	    $(".hero-slider__slide[data-slide=".concat(count, "]")).addClass('active');
	    setTimeout(function () {
	      $(".hero-slider-control__item[data-slide=".concat(count, "]")).addClass('animate');
	      $(".hero-slider__slide[data-slide=".concat(count, "]")).addClass('animate');
	    }, 1000);
	  }
