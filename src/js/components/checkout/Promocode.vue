    ...
    <div class="order-promocode__body" v-show="isActive">
      <div class="n-form-row">
        ...
        <div class="col-12 col-md-4">
          <button
            class="order-promocode__btn-submit btn btn-skew btn-block btn-gray-2" type="button"
            v-if="status === 'loading'">
            <span class="spinner-border spinner-border-sm" role="status"></span>
          </button>
          <button
            class="order-promocode__btn-submit btn btn-skew btn-block btn-green" type="button"
          ...
          <button
            class="order-promocode__btn-submit btn btn-skew btn-block btn-red" type="button"
