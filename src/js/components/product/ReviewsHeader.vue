<template>
  <div class="p-reviews-header">
    <h2 class="p-reviews-header__title">
      <span>Отзывы</span>
      <span v-show="activePacking.review > 0" class="p-reviews-header__count">{{ activePacking.review }}</span>
    </h2>
    <div v-show="activePacking.review > 0" class="p-reviews-header__rating">
      <div class="p-reviews-header__rating-stroke">
        <span class="p-reviews-header__rating-value">{{ activePacking.reviewRaiting }}</span>
