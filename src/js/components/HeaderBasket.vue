<template>
  <div class="header-control__cart-container">
    ...
    <a class="header-control__button header-control__button_cart"
       href="/checkout/"
      ...
      <a href="/checkout/"
        ...
        <div class="button-cart__inner">
          ...
          <div class="button-cart__block">
            ...
            <div class="button-cart__price"
                 v-if="totalPrice > 0">{{totalPrice | formatPrice}}
            </div>
          </div>
        </div>
      </a>
      ...
      <div :class="['header-cart', { 'active': isVisible }]"
        ...
        <div class="header-cart__wrapper">
          <div class="header-cart__header">
            ...
            <button class="header-cart__btn-clear"
                    type="button"
          ...
          <div class="header-cart__list">
            ...
            <div class="h-product-item"
              ...
              <div class="h-product-item__info">
                <a :href="item.url"
                   class="h-product-item__name">{{item.name || `Товар №${item.productId}`}}</a>
                <div class="h-product-item__description"
                     v-if="item.pack">{{item.pack}}
                </div>
              </div>
