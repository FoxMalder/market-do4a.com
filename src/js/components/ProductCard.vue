<template>
  <div class="product-card">
      ...
      <div class="product-card__footer" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
        ...
        <div class="product-card__row">
          <div class="product-card__reviews" itemprop="aggregateRating" itemscope="" itemtype="http://schema.org/AggregateRating">
            ...
            <span>{{getText(product.reviews, ['отзыв', 'отзыва', 'отзывов'])}}</span>
          </div>
    ...
    <div class="product-control">
      <button class="product-control__favorites" title="Добавить в избранное"
      ...
      <button class="product-control__compare" title="Сравнить"
    ...
    methods: {
      toggleFavorites() {
        if (product.isFavorite) {
          Api.favorites.delete(product.id).then(() => {
            product.isFavorite = false;
          });
        } else {
          Api.favorites.add(product.id).then(() => {
